...
//    }
    ...
    {
        dump('Ainda não funciona, tem que ver o caminho do docker compose');
        $process = Process::path(base_path())->quietly()->start('./docker stack deploy -c docker-compose.yml mary --with-registry-auth');
    }
...
<div wire:poll.4s>
    <x-header title="Stacks (mary)" separator progress-indicator>
        <x-slot:actions>
            <x-button label="Edit" link="/stacks/edit" icon="o-pencil" class="bg-base-300" responsive />
